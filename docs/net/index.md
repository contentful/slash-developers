...
[This tutorial](/developers/docs/net/tuorials/using-net-cda-sdk) will walk you through the first steps using the Content Delivery API with a .Net application.
